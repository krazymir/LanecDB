...
describe('Initialization - encrypt/descrypt', function () {
    ...
    it('Should decrypt the encrypted data', function () {
    ...
    it('Should sign the data and return a signature', function () {
        signature = utils.security.signString(data)
    })
    it('Should verify the data signature', function () {
    ...
    it('Should verify the request and check its correctness', function () {
        assert.equal(security.authorizeRequest(req, res), true, 'The request should be valid')
    })
    it('Should not authorize a request with if the data is changed subsequently', function () {
        req.body = '{"prop":6}'
    ...
    it('Should not authorize a request with if the signature is changed', function () {
    ...
    it('Should not authorize a request with if the public key is missing', function () {
    ...
    it('Should not authorize a request with if the signature is missing', function () {
